...
export function RequesterPersonalInfo({ requester }: RequesterPersonalInfoProps) {
  return (
    <div>
      ...
      <div className="space-y-4">
        <div className="bg-neutral-50 rounded-lg p-4 text-text-primary">
          ...
          <p className="text-base text-text-primary font-medium ml-8">{requester.email}</p>
        </div>
        ...
        <div className="bg-neutral-50 rounded-lg p-4 text-text-primary">
          ...
          <p className="text-base text-text-primary font-medium ml-8">{requester.phone}</p>
        </div>
        ...
        <div className="bg-neutral-50 rounded-lg p-4 text-text-primary">
          ...
          <p className="text-base text-text-primary font-medium ml-8">{requester.address}</p>
        </div>
