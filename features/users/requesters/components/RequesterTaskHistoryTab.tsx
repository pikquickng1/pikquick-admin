  ...
  return (
    <div className="bg-white rounded-2xl border border-light overflow-hidden">
      <div className="p-6 pb-0">
        ...
        <div className="bg-white border border-light border-b-0 p-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 max-w-sm relative">
              ...
              <Input
                type="text"
                placeholder="Search..."
                className="pl-10 h-10 border-neutral-200 bg-white"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
              />
            </div>

            <button className="h-10 px-4 border border-neutral-200 rounded-lg text-sm text-text-primary bg-white flex items-center gap-2 hover:bg-neutral-50">
              <span>Filter</span>
